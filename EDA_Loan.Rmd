...
- ClosedDate: Data aplicável para casos de alteração de Status para Cancelled, Completed, Chargedoff e Defaulted.
...
Das 81 variáveis foram selecionadas 18 que serão trabalhadas na análise.
...
qplot(Term, data = ld_clean, xlab = "Tempo em Meses", ylab = "Quantidade", main = "Histograma de quantidade de tempo de empréstimo")
```
