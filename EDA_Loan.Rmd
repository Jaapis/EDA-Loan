...
histograma(ld_clean$ListingCreationDate, 
           ld_clean, "Tempo (Meses)", 
           "Quantidade", 
...
normal com relação aos dados de retorno estimado apra cada empréstimo realizado. 
Com a maior concentração de seus valores em cerca de 0,9%. Curioso destacar que 
...
de uma avaliação própria da empresa será mais intieressante a exploração futura 
...
#TODO
## O projeto inclui uma seção de referência que discute a análise realizada.
## A seção fornece pelo menos uma ideia ou pergunta para trabalhos futuros.
